...
Octcoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Octcoin Core

**When configuring Octcoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Octcoin Core:
...
variables will be set when generating the Octcoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
