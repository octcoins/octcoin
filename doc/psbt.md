# PSBT Howto for Octcoin Core

Since Octcoin Core 0.17, an RPC interface exists for Partially Signed Octcoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/octcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Octcoin transactions that are not fully signed
...
#### Multisig with multiple Octcoin Core instances
