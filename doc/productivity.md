...
```sh
cmake --build build --target octcoind octcoin-cli
cmake --build build --target octcoin-qt
cmake --build build --target bench_octcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:octcoin/octcoin.git
```
...
> e.g. github.com/octcoin/octcoin.git or for the GUI github.com/octcoin-core/gui
