Octcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/octcoin/files/Octcoin/octcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Octcoin
...
New/changed settings (command-line or octcoin.conf file)
--------------------------------------------------------
