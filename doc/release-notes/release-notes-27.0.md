Octcoin Core version 27.0 is now available from:

  <https://octcoins.github.io/bin/octcoin-core-27.0/>
...
- liboctcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, liboctcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Octcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Octcoin Core would
