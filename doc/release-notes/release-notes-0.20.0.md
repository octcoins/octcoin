...
Octcoin Core version 0.20.0 is now available from:

  <https://octcoins.github.io/bin/octcoin-core-0.20.0/>
...
- Instead of running `make` simply, you should instead run
  `OCTCOIN_GENBUILD_NO_GIT=1 make`.
...
#### Removal of BIP61 reject network messages from Octcoin Core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Octcoin Core version 0.18.0.
...
- Testing or debugging of implementations of the Octcoin P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of Octcoin Core. Octcoin Core logs debug messages
...
- OpenSSL is no longer used by Octcoin Core.  (#17265)

- BIP70 support has been fully removed from Octcoin Core. The
...
- A new `-asmap` configuration option has been added to diversify the
  ...
  single ASN.  See [issue #16599]( https://github.com/octcoins/octcoin/issues/16599),
  [PR #16702]( https://github.com/octcoins/octcoin/pull/16702), and the
  `octcoind help` for more information.  This option is experimental and
...
- All custom settings configured when Octcoin Core starts are now
...
- The "Start Octcoin Core on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://octcoins.github.io/en/releases/0.18.0/#wallet-gui)
  in the release notes of version 0.18 has been fixed.  The issue
  affected anyone who simultaneously used multiple Octcoin Core wallets
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  automatically copy a Partially-Signed Octcoin Transaction (PSBT) to
  the system clipboard.  This can then be pasted into an external
  program such as [HWI](https://github.com/octcoin-core/HWI) for
  signing.  Future versions of Octcoin Core should support a GUI option
...
- Octcoin Core's automatically-generated source code documentation is
  now available at https://doxygen.octcoincore.org.  (#17596)
...
- The `octcoin-cli` utility used with the `-getinfo` parameter now
...
- The `octcoin-cli` utility now accepts a `-stdinwalletpassphrase`
...
- Command line options prefixed with main/test/regtest network names like
  `-main.port=8555` `-test.server=1` previously were allowed but ignored. Now
...
- #16666 Remove final comma for last entry of fixed-size arrays/objects in RPCResult (luke-jr)
...
- #17068 Always generate `octcoinstrings.cpp` on `make translate` (D4nte)
...
- #17741 Included `test_octcoin-qt` in msvc build (sipsorcery)
...
- #17910 Remove double `LIBOCTCOIN_SERVER` linking (fanquake)
...
- #18397 Fix libevent linking for `bench_octcoin` binary (hebasto)
- #18426 scripts: `Previous_release`: improve behaviour on failed download (theStack)
- #18429 Remove double `LIBOCTCOIN_SERVER` from bench-Makefile (brakmic)
...
- #18702 Fix ASLR for octcoin-cli on Windows (fanquake)
...
- #17009, #17018, #17050, #17051, #17071, #17076, #17083, #17093, #17109, #17113, #17136, #17229, #17291, #17357, #17771, #17777, #17917, #17926, #17972, #17989, #17996, #18009, #18029, #18047, #18126, #18176, #18206, #18353, #18363, #18407, #18417, #18423, #16667, #18455, #18565 Add fuzzing harnesses (practicalswift)
...
- #17206 Add testcase to simulate octcoin schema in leveldb (adamjonas)
...
- #17330 Add `shrinkdebugfile=0` to regtest octcoin.conf (sdaftuar)
...
- #18022 Fix appveyor `test_octcoin` build of `*.raw` (MarcoFalke)
...
- #18166 ci: Run fuzz testing test cases (octcoin-core/qa-assets) under valgrind to catch memory errors (practicalswift)
...
- #16556 Add basic test for BIP 37 (MarcoFalke)
...
- #18430 ci: Only clone octcoin-core/qa-assets when fuzzing (MarcoFalke)
...
- #16983 Add detailed info about Octcoin Core files (hebasto)
...
- #17119 Fix broken octcoin-cli examples (andrewtoth)
...
- #17503 Remove bitness from octcoin-qt help message and manpage (laanwj)
- #17539 Update and improve Developer Notes (hebasto)
- #17561 Changed MiniUPnPc link to https in dependencies.md (sandakersmann)
- #17596 Change doxygen URL to doxygen.octcoincore.org (laanwj)
...
- #17648 Rename wallet-tool references to octcoin-wallet (hel-o)
...
- #18341 Replace remaining literal OTC with `CURRENCY_UNIT` (domob1812)
...
- #16115 On octcoind startup, write config args to debug.log (LarryRuane)
...
- #17650 util: Remove unwanted fields from octcoin-cli -getinfo (malevolent)
