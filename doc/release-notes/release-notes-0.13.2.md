Octcoin Core version 0.13.2 is now available from:

  <https://octcoin.org/bin/octcoin-core-0.13.2/>
...
- #9292 `c385556` Complain when unknown rpcserialversion is specified (sipa)
...
- #8908 `4a974b2` Update octcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow octcoin-tx to create v2 transactions (btcdrak)
