Octcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/octcoin/files/Octcoin/octcoin-0.5.4/
...
http://gitorious.org/octcoin/octcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Octcoin-Qt notifications under Growl 1.3.
Increase required age of Octcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOctcoin properly when installing Octcoin-Qt over it. (Windows)
