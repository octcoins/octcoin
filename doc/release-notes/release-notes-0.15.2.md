Octcoin Core version *0.15.2* is now available from:

  <https://octcoins.github.io/bin/octcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in octcoin-tx (TheBlueMatt)
