...
Octcoin Core version 0.19.1 is now available from:

  <https://octcoins.github.io/bin/octcoin-core-0.19.1/>
...
From Octcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Octcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Octcoin Core does not yet change appearance when
...
- #17488 fix "octcoind already running" warnings on macOS (fanquake)
