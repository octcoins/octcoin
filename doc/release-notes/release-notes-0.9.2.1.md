Octcoin Core version 0.9.2.1 is now available from:

  https://octcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OTC to 0.01 OTC
...
- Fix "Start octcoin on system login"
