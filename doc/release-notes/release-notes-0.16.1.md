Octcoin Core version 0.16.1 is now available from:

  <https://octcoins.github.io/bin/octcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting octcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure octcoind processes are cleaned up when tests end (sdaftuar)
