Octcoin Core version 0.9.4 is now available from:

  https://octcoin.org/bin/0.9.4/
...
this update is incompatible with the Octcoin system and could lead to consensus
forks.

Octcoin Core released binaries from https://octcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~octcoin/+archive/ubuntu/octcoin
- A third-party or self-compiled Octcoin Core

upgrade to Octcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
