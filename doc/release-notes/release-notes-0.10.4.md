Octcoin Core version 0.10.4 is now available from:

  <https://octcoin.org/bin/octcoin-core-0.10.4/>
...
- #6953 `43c2789` Split octcoin-tx into its own package
- #6953 `dfe0d4d` Include octcoin-tx binary on Debian/Ubuntu
