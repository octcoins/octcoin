...
Assumeutxo is a feature that allows fast bootstrapping of a validating octcoind
instance.
...
```
$ octcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ octcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
