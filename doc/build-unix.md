UNIX BUILD NOTES
====================
Some notes on how to build Octcoin Core in Unix.
...
memory available when compiling Octcoin Core. On systems with less, gcc can be
...
To build Octcoin Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Octcoin Core can
