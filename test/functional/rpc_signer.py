...
Verify that a octcoind node can use an external signer command.
...
class RPCSignerTest(OctcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart octcoind with -signer=<cmd>',
