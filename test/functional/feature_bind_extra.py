...
"""
Test starting octcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(OctcoinTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that octcoind has bound on "::1" (for RPC) and "::" (for P2P).
