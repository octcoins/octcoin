...
""" Tests the utxocache:* tracepoint API interface.
    See  https://github.com/octcoins/octcoin/blob/master/doc/tracing.md#context-utxocache
"""
...
class UTXOCacheTracepointTest(OctcoinTestFramework):
    ...
    def test_uncache(self):
        """ Tests the utxocache:uncache tracepoint API.
         https://github.com/octcoins/octcoin/blob/master/doc/tracing.md#tracepoint-utxocacheuncache
        """
    ...
    def test_add_spent(self):
        """ Tests the utxocache:add utxocache:spent tracepoint API
            See  https://github.com/octcoins/octcoin/blob/master/doc/tracing.md#tracepoint-utxocacheadd
            and  https://github.com/octcoins/octcoin/blob/master/doc/tracing.md#tracepoint-utxocachespent
        """
    ...
    def test_flush(self):
        """ Tests the utxocache:flush tracepoint API.
            See  https://github.com/octcoins/octcoin/blob/master/doc/tracing.md#tracepoint-utxocacheflush"""
