#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Octcoin Core developers
...
# The block reward of coinbaseoutput.nValue (50) OTC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 OTC/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"octcoin-cli -h\" for help or \"octcoin-cli listwallets\" to see "
...
class TestOctcoinCli(OctcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `octcoin-cli getblockchaininfo`")
        ...
        # Prevent octcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and octcoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and octcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (OTC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (OTC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 OTC) to the default wallet.
            ...
            # Test octcoin-cli -generate with -rpcwallet in multiwallet mode.
