...
class TransactionTimeRescanTest(OctcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine OTC and create transactions
        ...
        # generate some bse to create transactions and check blockcount
        ...
        # send 10 bse to user's first watch-only address
        self.log.info('Send 10 bse to user')
        ...
        # send 5 bse to our second watch-only address
        self.log.info('Send 5 bse to user')
        ...
        # send 1 bse to our third watch-only address
        self.log.info('Send 1 bse to user')
