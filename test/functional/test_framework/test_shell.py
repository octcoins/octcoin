...
class TestShell:
    """Wrapper Class for OctcoinTestFramework.

    The TestShell class extends the OctcoinTestFramework
    ...
    class __TestShell(OctcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by OctcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # OctcoinTestFramework instances are supposed to be constructed with the path
