#!/usr/bin/env python3
# Copyright (c) 2015-present The Octcoin Core developers
...
REGTEST_N_BITS = 0x1e0377ae  # difficulty retargeting is disabled in REGTEST chainparams"
