#!/usr/bin/env python3
# Copyright (c) 2020-present The Octcoin Core developers
...
BECH32_INVALID_PREFIX = 'oct1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k7grplx'
...
class InvalidAddressErrorMessageTest(OctcoinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        if not self.options.usecli:
            ...
            assert_raises_rpc_error(-1, "Return information about the given octcoin address.", node.validateaddress)
