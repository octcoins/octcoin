#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Octcoin Core developers
...
class TxDownloadTest(OctcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new octcoind instances, as setting mocktimes has long-term effects on when
