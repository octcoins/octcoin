...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the OctcoinTestFramework
    pass


class ExampleTest(OctcoinTestFramework):
    # Each functional test is a subclass of the OctcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        OctcoinTestFramework class so other tests can use it."""
