...
class TxnMallTest(OctcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 OTC:
        ...
        # First: use raw transaction API to send 1240 OTC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 OTC coin each
        ...
        # Node0's balance should be starting balance, plus 50OTC for another
        ...
        # Node0's total balance should be starting balance, plus 100OTC for
