...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The octcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(OctcoinTestFramework):
    ...
    def run_test(self):
        ...
        # octcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that octcoind sends its own version prior to processing
