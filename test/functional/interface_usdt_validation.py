...
""" Tests the validation:* tracepoint API interface.
    See  https://github.com/octcoins/octcoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(OctcoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See  https://github.com/octcoins/octcoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
