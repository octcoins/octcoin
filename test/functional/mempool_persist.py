...
By default, octcoind will dump mempool on shutdown and
...
class MempoolPersistTest(OctcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent octcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
