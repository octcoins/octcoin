...
class OctcoinChainstateTest(OctcoinTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_octcoin_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing octcoin-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    OctcoinChainstateTest(__file__).main()
