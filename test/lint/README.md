...
```sh
DOCKER_BUILDKIT=1 docker build -t octcoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/octcoin -it octcoin-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/octcoin-core/crc32c-subtree.git (branch octcoin-fork)
* for `src/crypto/ctaes`: https://github.com/octcoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/octcoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/octcoin-core/leveldb-subtree.git (branch octcoin-fork)
* for `src/minisketch`: https://github.com/octcoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/octcoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/octcoin-core/secp256k1.git
```
