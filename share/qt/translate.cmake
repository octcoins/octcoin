...
function(extract_strings output)
  ...
  file(STRINGS "octcoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *octcoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"octcoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/octcoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/octcoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/octcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/octcoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/octcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/octcoin_en.xlf" octcoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" octcoin_en "${octcoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" octcoin_en "${octcoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/octcoin_en.xlf" "${octcoin_en}")
