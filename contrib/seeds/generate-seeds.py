...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef OCTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define OCTCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the octcoin network\n')
    ...
    g.write('#endif // OCTCOIN_CHAINPARAMSSEEDS_H\n')
