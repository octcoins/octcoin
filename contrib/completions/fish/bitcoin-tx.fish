...
# Extract options
function __fish_octcoin_tx_get_options
...
# Extract commands
function __fish_octcoin_tx_get_commands
...
complete \
    --command octcoin-tx \
    --condition "not __fish_octcoin_seen_cmd (__fish_octcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_octcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command octcoin-tx \
    --arguments "(__fish_octcoin_tx_get_commands)" \
    --no-files
