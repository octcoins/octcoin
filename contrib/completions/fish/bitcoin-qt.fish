...
complete --command octcoin-qt --no-files

# Extract options
function __fish_octcoinqt_get_options
...
complete \
    --command octcoin-qt \
    --arguments "(__fish_octcoinqt_get_options --nofiles)"
