...
complete --command octcoind --no-files

# Extract options
function __fish_octcoind_get_options
...
complete \
    --command octcoind \
    --arguments "(__fish_octcoind_get_options --nofiles)"
