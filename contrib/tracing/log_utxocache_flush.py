...
"""Example logging Octcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/octcoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[octcoind_with_usdts])
