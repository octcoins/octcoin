...
(define* (make-octcoin-cross-toolchain target
                                       #:key
...
desirable for building Octcoin Core release binaries."
...
;; failure; see  https://github.com/octcoins/octcoin/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-octcoin-cross-toolchain target)))
