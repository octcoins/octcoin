...
#include <algorithm>
#include <attributes.h> // Added for Octcoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Octcoin Core
#include <util/string.h> // Added for Octcoin Core
...
// Added for Octcoin Core. Similar to std::runtime_format from C++26.
...
// Added for Octcoin Core. Wrapper for checking format strings at compile time.
