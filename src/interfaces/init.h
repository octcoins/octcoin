...
#ifndef OCTCOIN_INTERFACES_INIT_H
#define OCTCOIN_INTERFACES_INIT_H
...
//! (octcoin-gui, octcoin-node, octcoin-wallet, octcoind, octcoin-qt) and each
...
#endif // OCTCOIN_INTERFACES_INIT_H
