...
#ifndef OCTCOIN_INTERFACES_NODE_H
#define OCTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a octcoin node (octcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or octcoin.conf.
...
#endif // OCTCOIN_INTERFACES_NODE_H
