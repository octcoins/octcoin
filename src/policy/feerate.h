...
#ifndef OCTCOIN_POLICY_FEERATE_H
#define OCTCOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "OTC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    OTC_KVB,      //!< Use OTC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::OTC_KVB) const;
...
#endif // OCTCOIN_POLICY_FEERATE_H
