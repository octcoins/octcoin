...
#ifndef OCTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define OCTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // OCTCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
