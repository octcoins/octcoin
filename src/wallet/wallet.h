...
#ifndef OCTCOIN_WALLET_WALLET_H
#define OCTCOIN_WALLET_WALLET_H
...
public:
     ...
     * octcoin-wallet tool code or by wallet migration code. If this is called
