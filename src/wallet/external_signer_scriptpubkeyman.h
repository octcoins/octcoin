...
#ifndef OCTCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define OCTCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // OCTCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
