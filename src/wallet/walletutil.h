...
#ifndef OCTCOIN_WALLET_WALLETUTIL_H
#define OCTCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! octcoin from opening the wallet, thinking it was newly created, and
...
#endif // OCTCOIN_WALLET_WALLETUTIL_H
