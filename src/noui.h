...
#ifndef OCTCOIN_NOUI_H
#define OCTCOIN_NOUI_H
...
/** Connect all octcoind signal handlers */
void noui_connect();

/** Redirect all octcoind signal handlers to LogInfo. Used to check or suppress output during test runs that produce expected errors */
void noui_test_redirect();

/** Reconnects the regular Non-GUI handlers after having used noui_test_redirect */
void noui_reconnect();

#endif // OCTCOIN_NOUI_H
