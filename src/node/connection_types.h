...
#ifndef OCTCOIN_NODE_CONNECTION_TYPES_H
#define OCTCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/octcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Octcoin’s Peer-to-Peer Network")
...
#endif // OCTCOIN_NODE_CONNECTION_TYPES_H
