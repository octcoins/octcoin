...
#ifndef OCTCOIN_COMMON_SIGNMESSAGE_H
#define OCTCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's octcoin address, it must refer to a public key.
...
#endif // OCTCOIN_COMMON_SIGNMESSAGE_H
