...
#ifndef OCTCOIN_COMMON_ARGS_H
#define OCTCOIN_COMMON_ARGS_H
...
extern const char * const OCTCOIN_CONF_FILENAME;
extern const char * const OCTCOIN_SETTINGS_FILENAME;
