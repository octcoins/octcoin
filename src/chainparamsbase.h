...
#ifndef OCTCOIN_CHAINPARAMSBASE_H
#define OCTCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between octcoin-cli and octcoind)
 * of a given instance of the Octcoin system.
 */
...
#endif // OCTCOIN_CHAINPARAMSBASE_H
