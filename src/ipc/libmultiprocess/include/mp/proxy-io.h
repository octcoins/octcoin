...
extern thread_local ThreadContext g_thread_context; // NOLINT(octcoin-nontrivial-threadlocal)
// Silence nonstandard octcoin tidy error "Variable with non-trivial destructor
