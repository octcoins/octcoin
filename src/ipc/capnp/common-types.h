...
#ifndef OCTCOIN_IPC_CAPNP_COMMON_TYPES_H
#define OCTCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between octcoin processes.
...
//! Functions to serialize / deserialize common octcoin types.
namespace mp {
...
#endif // OCTCOIN_IPC_CAPNP_COMMON_TYPES_H
