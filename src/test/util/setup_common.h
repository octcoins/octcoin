...
#ifndef OCTCOIN_TEST_UTIL_SETUP_COMMON_H
#define OCTCOIN_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see  https://github.com/octcoins/octcoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // OCTCOIN_TEST_UTIL_SETUP_COMMON_H
