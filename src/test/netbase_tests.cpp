...
{
    BOOST_CHECK(TestSplitHost("www.octcoincore.org", "www.octcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.octcoincore.org]", "www.octcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.octcoincore.org:80", "www.octcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.octcoincore.org]:80", "www.octcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::8555", "::8555", 0));
    BOOST_CHECK(TestSplitHost(":8555", "", 8555));
    BOOST_CHECK(TestSplitHost("[]:8555", "", 8555));
    ...
    BOOST_CHECK(TestSplitHost("www.octcoincore.org:65536", "www.octcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.octcoincore.org:0", "www.octcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.octcoincore.org:", "www.octcoincore.org:", 0, false));
}
