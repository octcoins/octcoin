...
#ifndef OCTCOIN_TEST_SCRIPTNUM10_H
#define OCTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Octcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // OCTCOIN_TEST_SCRIPTNUM10_H
