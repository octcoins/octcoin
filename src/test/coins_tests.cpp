...
public:
    ...
    {
        auto base_cache_coin{base_value == ABSCNT ? MISSING : CoinEntry{base_value, CoinEntry::State::DIRTY}};
...
BOOST_AUTO_TEST_CASE(ccoins_access)
{
     ...
     *                  Base        Cache               Expected
     */
    for (auto base_value : {ABSCNT, SPENT, VALUE1}) {
...
{
    SingleEntryCacheTest test{ABSCNT, parent};
