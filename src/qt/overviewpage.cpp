...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = OctcoinUnits::formatWithUnit(unit, amount, true, OctcoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    OctcoinUnit unit{OctcoinUnit::OTC};
...
{
    OctcoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(OctcoinUnits::formatWithPrivacy(unit, balances.balance, OctcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(OctcoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, OctcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(OctcoinUnits::formatWithPrivacy(unit, balances.immature_balance, OctcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(OctcoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, OctcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("OTC")
    updateDisplayUnit();
}
