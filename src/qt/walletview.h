...
#ifndef OCTCOIN_QT_WALLETVIEW_H
#define OCTCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a octcoin wallet, and offers access to
