...
#ifndef OCTCOIN_QT_OCTCOINUNITS_H
#define OCTCOIN_QT_OCTCOINUNITS_H
...
/** Octcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class OctcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit OctcoinUnits(QObject *parent);

    /** Octcoin units.
      @note Source: https://en.octcoin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        OTC,
        mOTC,
