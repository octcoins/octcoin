...
#ifndef OCTCOIN_QT_OPTIONSMODEL_H
#define OCTCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Octcoin client.
...
public:
    ...
    OctcoinUnit getDisplayUnit() const { return m_display_octcoin_unit; }
...
private:
    ...
    QString language;
    OctcoinUnit m_display_octcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(OctcoinUnit unit);
...
#endif // OCTCOIN_QT_OPTIONSMODEL_H
