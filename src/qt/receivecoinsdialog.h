...
#ifndef OCTCOIN_QT_RECEIVECOINSDIALOG_H
#define OCTCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of octcoins */
...
#endif // OCTCOIN_QT_RECEIVECOINSDIALOG_H
