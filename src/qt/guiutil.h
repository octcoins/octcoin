...
#ifndef OCTCOIN_QT_GUIUTIL_H
#define OCTCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Octcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "octcoin:" URI into recipient object, return true on successful parsing
