      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->octcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->octcoinAtStartup);
    ...
    ui->octcoinAtStartup->setToolTip(ui->octcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->octcoinAtStartup->setText(ui->octcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openOctcoinConfButton->setToolTip(ui->openOctcoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new OctcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->octcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openOctcoinConfButton_clicked()
{
