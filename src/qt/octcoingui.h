...
#ifndef OCTCOIN_QT_OCTCOINGUI_H
#define OCTCOIN_QT_OCTCOINGUI_H
...
/**
  Octcoin GUI main class. This class represents the main window of the Octcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class OctcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit OctcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~OctcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a octcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, OctcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Octcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(OctcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // OCTCOIN_QT_OCTCOINGUI_H
