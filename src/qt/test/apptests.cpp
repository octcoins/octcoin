...
//! Entry point for OctcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &OctcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for OctcoinGUI tests.
void AppTests::guiTests(OctcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &OctcoinGUI::consoleShown, this, &AppTests::consoleTests);
