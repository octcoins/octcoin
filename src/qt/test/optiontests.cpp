...
{
    // Test regression  https://github.com/octcoins/octcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/octcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/octcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Octcoin/Octcoin-Qt.conf and all else left as default,
    // octcoin-qt should set both -listen and -listenonion to false and start successfully.
