...
#ifndef OCTCOIN_QT_SPLASHSCREEN_H
#define OCTCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Octcoin Core initialization
...
#endif // OCTCOIN_QT_SPLASHSCREEN_H
