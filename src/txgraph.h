...
#ifndef OCTCOIN_TXGRAPH_H
#define OCTCOIN_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingoctcoin.org/t/introduction-to-cluster-linearization/1032
 *
