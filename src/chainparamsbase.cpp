...
/**
 * Port numbers for incoming Tor connections (6556, 16556, 36556, 46556, 16667) have
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 48554);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 38554);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 16665);
    }
    assert(false);
}
