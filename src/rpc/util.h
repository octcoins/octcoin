...
#ifndef OCTCOIN_RPC_UTIL_H
#define OCTCOIN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting OTC/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1OTC/kvB.
 */
