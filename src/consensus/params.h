...
#ifndef OCTCOIN_CONSENSUS_PARAMS_H
#define OCTCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Octcoin Script solution
...
#endif // OCTCOIN_CONSENSUS_PARAMS_H
