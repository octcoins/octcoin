...
#ifndef OCTCOIN_ARITH_UINT256_H
#define OCTCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Octcoin only uses this "compact" format for encoding difficulty
