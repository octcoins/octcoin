...
#ifndef OCTCOIN_TXREQUEST_H
#define OCTCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://octcoins.github.io/en/2024/07/03/disclose_already_asked_for.
 */
